package com.zensar.springbootdemo.couponaop;
...
import com.zensar.springbootdemo.couponexception.CouponAlreadyExistsException;
import com.zensar.springbootdemo.couponexception.NoSuchCouponExistsException;

@Aspect
@Configuration
public class CouponAop {
	
	/*LOGGING*/
	private Logger log = LoggerFactory.getLogger(CouponAop.class);
